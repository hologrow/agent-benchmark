...
import type { BuiltinIntegrationPluginMeta } from "@/lib/plugins/builtin-integration-plugins.types";
...
export function SettingsPageClient({
  ...
  builtinPlugins: BuiltinIntegrationPluginMeta[];
}) {
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <Tabs value={activeTab} onValueChange={handleTabChange} className="space-y-6">
        ...
        <TabsContent value="integrations">
          <IntegrationsManagement plugins={builtinPlugins} />
        </TabsContent>
      </Tabs>
    </div>
  );
